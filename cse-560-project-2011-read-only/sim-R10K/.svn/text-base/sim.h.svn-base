 ...
 *
 * $Id: sim.h,v 1.5 1998/08/27 16:38:54 taustin Exp taustin $
 *
 * $Log: sim.h,v $
...
extern unsigned long long insn_dumpbegin;
extern unsigned long long insn_dumpend;
extern FILE *fdump;
...
extern enum sample_mode_t sample_mode;

extern unsigned long long insn_limit;
extern unsigned long long insn_sample[sample_NUM];

extern unsigned long long insn_sample_first[sample_NUM];

extern unsigned long long insn_progress_update;
extern counter_t insn_progress;
...
void sim_start(void);
bool_t sim_sample_off(unsigned long long n_insn);
bool_t sim_sample_warmup(unsigned long long n_insn);
bool_t sim_sample_on(unsigned long long n_insn);
